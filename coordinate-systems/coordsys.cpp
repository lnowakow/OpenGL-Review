...
int main(int argc, char** argv) {
    ...
    while(!glfwWindowShouldClose(window)) {
        ...
        /* arg1: fovy - the angle of the perspective from the camera middle line in y-dir
         * arg2: aspect ration relative to that povy spread
         * arg3: zNear clipping distance
         * arg4: zFar clipping distance
         */
